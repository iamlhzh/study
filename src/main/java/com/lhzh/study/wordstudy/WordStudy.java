package com.lhzh.study.wordstudy;
...
//        CTTcBorders ctTcBorders = tcPr.addNewTcBorders();
        ...
        XWPFTableCell cell = comTableRowTwo.getCell(0);
        CTTc ctTc = cell.getCTTc();
        CTTcPr tcPr = ctTc.getTcPr();
        CTTcBorders ctTcBorders = tcPr.addNewTcBorders();
...
//        comTableRowTwo.getCell(3).getCTTc().getTcPr().addNewTcBorders().addNewLeft().setVal(STBorder.NIL);
//        comTableRowTwo.getCell(0).getCTTc().getTcPr().addNewTcBorders().addNewLeft().setVal(STBorder.NIL);
